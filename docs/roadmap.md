...
| Phase 4 – Finance | 🔶 In Progress (Stage 1 — core billing/manual payments — and Stage 2 — live M-Pesa STK Push/callback — complete; Payroll/ExpenseRecord (Stage 3) remain) |
